...
def get_args():
    ...
    parser.add_argument("--spk-anchor", dest="spk_anchor", type=str,
                        help="""A word that indicates the change of speaker in
                        transcription. The ctm_edit file will be splitted at this
                        anchor.""")
...
class Segment(object):
    ...
    def possibly_split_segment(self, max_internal_silence_length,
                               spk_anchor, max_internal_non_scored_length):
        """
