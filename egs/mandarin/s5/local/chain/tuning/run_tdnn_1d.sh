...
gmm_dir=exp/${gmm}${nnet3_affix}
ali_dir=exp/${gmm}${nnet3_affix}_sp_ali
tree_dir=exp/chain${nnet3_affix}/tree_sp${tree_affix:+_$tree_affix}
lang=data/lang_with_giga_test_chain
lang_ext="_with_giga_test"
lat_dir=exp/chain${nnet3_affix}/${gmm}${nnet3_affix}_sp_lats
...
local/chain/run_chain_common.sh --stage $stage \
                                ...
                                --lang $lang \
                                --lang-original data/lang${lang_ext} \
                                --lat-dir $lat_dir \
                                --num-leaves 7000 \
...
graph_dir=$dir/graph${lang_ext}
if [ $stage -le 16 ]; then
  # Note: it might appear that this $lang directory is mismatched, and it is as
  # far as the 'topo' is concerned, but this script doesn't read the 'topo' from
  # the lang directory.
  utils/mkgraph.sh --self-loop-scale 1.0 --remove-oov data/lang${lang_ext} $dir $graph_dir
...
echo "Training chain tdnn succeeded !"
exit 0
iter_opts=
...
if [ $stage -le 17 ]; then
  ...
  for decode_set in test_clean test_other dev_clean dev_other; do
      ...
      steps/nnet3/decode.sh --acwt 1.0 --post-decode-acwt 10.0 \
          ...
          $dir/decode_${decode_set}${decode_iter:+_$decode_iter}${lang_ext} || exit 1
      steps/lmrescore.sh --cmd "$decode_cmd" --self-loop-scale 1.0 data/lang${lang_ext} \
          data/${decode_set}_hires
          $dir/decode_${decode_set}${decode_iter:+_$decode_iter}${lang_ext} || exit 1
      steps/lmrescore_const_arpa.sh \
          --cmd "$decode_cmd" data/lang${lang_ext} \
          data/${decode_set}_hires
          $dir/decode_${decode_set}${decode_iter:+_$decode_iter}${lang_ext} || exit 1
      steps/lmrescore_const_arpa.sh \
          --cmd "$decode_cmd" data/lang${lang_ext} \
  ...
  for data in test_clean test_other dev_clean dev_other; do
    (
      ...
      steps/online/nnet3/decode.sh \
          ...
          $graph_dir data/${data} ${dir}_online/decode_${data}${lang_ext} || exit 1
