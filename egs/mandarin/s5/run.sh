...
dev_dir=data/dev
lang_dir=data/lang_with_giga_test
decode_lang=data/lang_with_giga
ext=""
...
if [[  $(hostname -f) ==  *.clsp.jhu.edu ]]; then
  ...
  utils/create_split_dir.pl /export/b{05,06,07,08}/$USER/kaldi-data/egs/mandarin/s5/$mfcc/storage \
    $mfccdir/storage
fi
