...
$sum=0;
#print "phoneid 19 is in class: $hashmap{19}\n";
...
foreach $k(@$array_lat) # per frame
{
  ...
  for (my $j=0;$j<$numkey;$j+=2)
  {
    ...
    {
	    #print "Phone id $arraykey[$j] is class: $phone_id, ";
	    #print "Adding $array_phone_post[$phone_init_id-1] with "; 
	    $array_phone_post[$phone_id-1]+=$phone_post;
	    #print " $phone_post \n";
    }
    else
    {
	    #print "new pseudo id: $arraykey[$j] in class $phone_id \n";
