...
import sys
import os
sys.path.append('/export/b07/jyang/kaldi-jyang/kaldi/egs/magic-200-spk/s5/tools')
...
def compute_distance(feats, method='kl', delta_t=list(range(10,81,5))):
...
def main():
    ...
    (description='Computing m-measure score for input MFCC features')
   ...
   # os.makedirs(args.o, exist_ok = True)
    ...
    with open(args.i, 'r') as s:
        ...
        for i, j in enumerate(files): 
            ...
            ("copy-feats scp:\"awk \'NR=={count}\' {f} |\" ark,t:-".format(count=i+1, f=args.i), shell=True)
